...
export default class extends React.Component{
    ...
    render(){
        ...
        const loadProperty = async () => {
            ...
            await console.log("Apartment Data: ",temp1)
        ...
        return(
            <div>
                ...
                { this.state.property[0] ? this.state.property.map((x) => { return <Template key={x.name} data={x} />}) : <div>Click to get apartments</div> }
            </div>
        )
    }
}
